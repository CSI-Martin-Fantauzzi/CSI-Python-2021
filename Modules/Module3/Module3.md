...
What is the difference between "42" and 42.
 ...
 - Answer: The first 42 is a string and the second 42 is an integer.

Define the boolean operators: >, <, ==, >=, <=

 - Answer: Greater than, less than, equals, greater than or equal, less than or equal. 
...
What is the first index of a list? Why?
 ...
 - Answer: the first index of a list is 0. Because the binary code starts in 0. 

Provide an original example of a null value. It must prove your understanding of the concept.

 - Answer: The grade of a class is null until the first assignment is graded. 
